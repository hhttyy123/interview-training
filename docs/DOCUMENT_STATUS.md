...
- `docs/technical/实时语音对话V0原型实施方案.md`
- `docs/technical/实时语音对话分步实施路线图.md`
- `docs/technical/实时语音对话项目目录框架.md`
...
- 临时阶段记录不应长期散落在 `docs/technical/`，阶段结束后要合并到对应 active 文档或移入 `docs/archive/`。
