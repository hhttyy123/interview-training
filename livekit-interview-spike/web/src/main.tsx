          ...
          <WizardCard title="上传个人材料">
            ...
            {config.resumeText && (
              <div className="resume-preview-card">
                <div><strong>简历预览</strong><span>{config.resumeText.length} 字</span></div>
                <p>{config.resumeText.slice(0, 700)}{config.resumeText.length > 700 ? "..." : ""}</p>
              </div>
            )}
          </WizardCard>
        )}
      ...
      <article className="setup-card full-field">
        ...
        {config.resumeText && (
          <div className="resume-preview-card">
            <div>
              <strong>简历预览</strong>
              <span>{config.resumeText.length} 字</span>
            </div>
            <p>{config.resumeText.slice(0, 420)}{config.resumeText.length > 420 ? "..." : ""}</p>
          </div>
        )}
      </article>
